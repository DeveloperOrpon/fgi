    ...
    return Scaffold(
      ...
      body: Obx(() {
          return SmartRefresher(
            ...
            controller: orderController.refreshAcceptController,
            onRefresh: () {
              printLog("onRefresh");
              orderController.onRefreshAcceptPage();
            },
            onLoading: () {
              printLog("onLoading");
              orderController.onLoadingAcceptPage();
            },
            child: CustomScrollView(
              ...
              slivers: [
                                  ...
                                  text: TextSpan(
                                      children: [
                                        TextSpan(
                                          ...
                                          text:
                                          orderController.acceptOrderResponse.value==null?"0": "  ${orderController.acceptOrderResponse.value!.meta!.totalOrders}(Orders)",
                ...
                (orderController.acceptOrderResponse.value==null)?
                SliverList(delegate: SliverChildListDelegate([
                  Lottie.asset('assets/animation/loadingScreen.json')
                ])):orderController.acceptOrderResponse.value!=null && orderController.acceptOrderList.value.isEmpty?
                SliverList(delegate: SliverChildListDelegate([
                  Lottie.asset('assets/animation/nodata.json')
                ]))
                    :SliverList(
                    delegate: SliverChildBuilderDelegate((context, index) {
                      final orderModel=orderController.acceptOrderList.value[index];
                      String productInfo='';
                    ...
                    },childCount: orderController.acceptOrderList.value.length)),
