...
class BrandCategoryByProductScreen extends StatefulWidget {
  final String categoryName;
  final String brandName;

  const BrandCategoryByProductScreen(
      {Key? key, required this.categoryName, required this.brandName})
      : super(key: key);

  @override
  State<BrandCategoryByProductScreen> createState() =>
      _BrandCategoryByProductScreenState();
}

class _BrandCategoryByProductScreenState
    extends State<BrandCategoryByProductScreen> {
  int page = 1;
  ...
  void initProduct(int page) {
    categoryController
        .getProductByBrandCategory(widget.categoryName, widget.brandName, page)
        .then((value) {
      page++;
