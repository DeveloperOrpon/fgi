...
class SingleProductUiWidget extends StatefulWidget {
  ...
  const SingleProductUiWidget({Key? key, required this.index,  this.isShowCount=true,  this.isShowByNowButton=true}) : super(key: key);
...
class _SingleProductUiWidgetState extends State<SingleProductUiWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Get.to(ProductDetailsScreen(product: products[0]),transition: Transition.upToDown);
      },
      child: Container(
