...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(authenticationController.brandList.value.isEmpty || authenticationController.currentAddress.value==''){
      Future.delayed(Duration.zero,() async {
        await authenticationController.getAllBrands();
        await authenticationController.getCurrentLocation();
      },);
    }
    return WillPopScope(
      onWillPop: () async {
                          ...
                          child: Obx(() {
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) => InkWell(
                                onTap: () {
                                  FocusScope.of(context).unfocus();
                                  log('Total Brand: ${authenticationController.brandList.length}');
                                  authenticationController.selectCompany.value =
                                      authenticationController
                                          .brandList.value[index];
                                },
                                child: Obx(() {
                                  return authenticationController
                                      .brandList.value.isEmpty?CupertinoActivityIndicator(): Container(
                                ...
                                ? SlideInLeft(
                                    ...
                                    child: Obx((){
                                        return TextFormField(
                                            ...
                                            obscureText: !authenticationController.isShowPassword.value,
                                            style: const TextStyle(
                                                color: Colors.white),
                                            decoration: InputDecoration(
                                                hintText: 'Password',
                                    ...
                                    child: Padding(
                                      ...
                                      child: Obx(() {
                                          return TextFormField(
                                              ...
                                              obscureText: !authenticationController.isShowConfirmPassword.value,
                                              controller: authenticationController
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Text(
                                        "Company: ${"${authenticationController.selectCompany.value!.brandLabel}"}",
                                        style: const TextStyle(
                                            color: Colors.white,
                                            fontSize: 14,
                                            fontWeight: FontWeight.w400),
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    "Location: ${authenticationController.addressController.text}",
                                    style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400),
  ...
  void _signUpUser(
    ...
    authenticationController.signUpUser(context).then((value){
      if(value){
        authenticationController.showAccountCreateDialog(context);
      }
    });
  }
}
